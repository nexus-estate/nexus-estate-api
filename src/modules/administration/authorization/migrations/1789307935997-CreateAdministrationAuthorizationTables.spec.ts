import { CreateAdministrationAuthorizationTables1789307935997 } from './1789307935997-CreateAdministrationAuthorizationTables';
...
describe('CreateAdministrationAuthorizationTables', () => {
  it('creates scoped administration tables and bootstraps internal roles', async () => {
    ...
    await new CreateAdministrationAuthorizationTables1789307935997().up(
      runner as never,
    );
  ...
  it('can remove only the tables owned by the migration on down', async () => {
    ...
    await new CreateAdministrationAuthorizationTables1789307935997().down({
      query,
      dropTable,
    } as never);
