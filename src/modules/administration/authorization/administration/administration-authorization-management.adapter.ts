...
@Injectable()
export class AdministrationAuthorizationManagementAdapter implements PlatformAuthorizationManagementPort {
  readonly platform = AuthorizationPlatform.ADMINISTRATION;
