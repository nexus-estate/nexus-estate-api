import { MigrateLegacyUserSchemaToCustomerAccount1789307935990 } from './1789307935990-MigrateLegacyUserSchemaToCustomerAccount';
...
describe('MigrateLegacyUserSchemaToCustomerAccount', () => {
  ...
  it('is explicitly forward-only', async () => {
    await expect(
      new MigrateLegacyUserSchemaToCustomerAccount1789307935990().down(),
