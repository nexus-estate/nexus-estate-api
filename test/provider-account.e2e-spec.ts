...
import { ProviderAccountErrorCodes } from '../src/modules/provider/errors/provider-account-error-codes';
...
describe('ProviderAccount API (e2e)', () => {
  ...
  beforeEach(async () => {
    await dataSource.query(
      'TRUNCATE TABLE tbl_provider_account, tbl_customer_account, tbl_role, tbl_permission CASCADE',
    );
